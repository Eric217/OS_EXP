...
#define DESC_G_4K       1
#define DESC_D_32       1
#define DESC_L          0    // 64位代码标记，目前 0
#define DESC_AVL        0    // cpu不用此位，暂置 0
#define DESC_P          1
#define DESC_DPL_0      0
#define DESC_DPL_1      1
#define DESC_DPL_2      2
#define DESC_DPL_3      3
#define DESC_S_CODE     1     // 代码段和数据段属于存储段，tss、门描述符属于系统段，S=0
#define DESC_S_DATA     DESC_S_CODE
#define DESC_S_SYS      0
#define DESC_TYPE_CODE  8     // xcra=1000,可执行,非依从,不可读,未访问
#define DESC_TYPE_DATA  2    // xewa=0010,不可执行,向上扩展,可写,未访问
#define DESC_TYPE_TSS   9    // Busy 位 0
